...
public class PoiTest {
	...
	public static void testXlsx2() {
		File f = new File("test2.xlsx");
	...
	public static void testXlsx1() {
		...
		try {
			...
			.range("C1:Z1")
				...
				.setValue("右寄せ")
				.selected()
			.saveBook(new File("test1-1.xlsx"));
			//test1-1.xlsxで保存
	...
	public static void testXls1() {
		
		File f = new File("test1.xls");
